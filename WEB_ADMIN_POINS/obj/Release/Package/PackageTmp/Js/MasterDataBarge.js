        ...
        schema: {
            ...
            model: {
                ...
                field: {
                    ...
                    BARGE: { type: "string", editable: true, sortable: true },
...
$("#grid").kendoGrid({
    ...
    //},
    columns: [
        { field: 'BARGE', title: 'Nama Barge', width: '150px', attributes: { style: "text-align:center;" } },
        {
            title: 'Action',
            width: '120px',
...
function Delete(id1) {
    ...
    if (ans) {
        $.ajax({
            type: "POST",
            url: $("#web_link").val() + "/api/MasterData/DeleteMasterBarge",
            data: JSON.stringify(obj),
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success: function (data) {
